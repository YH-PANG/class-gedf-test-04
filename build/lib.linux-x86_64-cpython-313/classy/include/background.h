...
struct background
{
  ...
  double Omega0_edf;       /**< EDF by yehuang */
  double Omega_edf_zc;
  ...
  double zc_edf;
  double s_a;
  double w_edf;    /**< equation of state of EDF by yehuang */
  double wi_edf;
  double wf_edf;
  double cs2_edf;
  double Theta_i_edf;
  ...
  int index_bg_rho_edf;       /**< EDF density by yehuang */
  ...
  int index_bg_rho_tot_bar;   /**< Total density except for EDF */
