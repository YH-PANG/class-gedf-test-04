...
struct perturbations
{
  ...
  short has_source_theta_edf;  /**< by yehuang */
  ...
  int index_tp_theta_edf;   /**< by yehuang */
  int index_tp_u_edf;
...
struct perturbations_vector
{
  ...
  int index_pt_delta_edf;  /**< by yehuang */
  int index_pt_theta_edf;
  int index_pt_u_edf;  
  // int index_pt_cs2_edf;    /**< Add to get cs2_edf outputs */
  // int index_pt_ca2_edf;
  int index_pt_Gamma_edf;
...
struct perturbations_workspace
{
  ...
  */
  ...
  double delta_rho_edf;        
  double delta_p_edf;          
  double rho_plus_p_theta_edf; 
  double delta_edf;
  double cs2_edf_output;
  double ca2_edf_output;
  double S_edf;                
  double Gamma_prime_edf;
  double delta_rho_gedf;        
  double delta_p_gedf;          
  double rho_plus_p_theta_gedf; 
  double delta_gedf;
  double ca2_gedf_output;
